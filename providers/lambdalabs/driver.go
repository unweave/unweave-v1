...
func NewAuthenticatedLambdaLabsDriver(apiKey string) (execsrv.Driver, error) {
...
func (d *execDriver) listNodeTypes(ctx context.Context, filterAvailable bool) ([]types.NodeType, error) {
...
func (d *execDriver) findRegionForNode(ctx context.Context, nodeTypeID string) (string, error) {
...
func (d *execDriver) Get(ctx context.Context, id string) (types.Exec, error) {
	//TODO implement me
	panic("implement me")
}
...
func (d *execDriver) sshKeyList(ctx context.Context) ([]types.SSHKey, error) {
...
func (d *execDriver) sshKeyRegister(ctx context.Context, pubKey string) (string, error) {
